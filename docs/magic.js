...
var initialState = {
  ...
  'menu': [{
    ...
    'items': [{
      ...
      'text': 'transmute html',
      'to': '-transpile-html-string'
    }, {
      'text': 'transmute markdown',
      'to': '-transpile-markdown-string'
    }, {
      'text': 'html file',
      'to': '-html-file'
    }, {
...
var pages = {
  '/transmute/': function transmute(state) {
    return [h1({
      id: 'magictransmute'
    }, "@magic/transmute"), div([GitBadges('magic/transmute'), h3({
      id: 'installation'
    }, 'installation'), h4({
      id: 'installation-cli'
    }, 'cli:'), Pre("\nnpm i -g @magic/transmute\n\n// executable as magic-transmute now\nmagic-transmute\n"), h4({
      id: 'installation-api'
    }, 'javascript api'), Pre('npm i --save @magic/transmute'), h3({
      id: 'usage'
    }, 'usage'), h4({
      id: 'usage-cli'
    }, 'cli:'), Pre('magic-transmute --help'), h4({
      id: 'usage-cli-commands'
      ...
      id: 'usage-cli-transpile-html-string'
    }, 'transpile html string:'), Pre("magic-transmute html --str '<a href=\"https://magic.github.io\">magic!</a>'"), h5({
      id: 'usage-cli-transpile-markdown-string'
    }, 'transpile markdown string:'), Pre("magic-transmute markdown --str '[magic!](https://magic.github.io)'"), h5({
      id: 'usage-cli-html-file'
    }, 'html file:'), Pre('magic-transmute file --input input.html --output output.mjs'), h5({
      id: 'usage-cli-markdown-file'
    }, 'markdown file'), p('(.markdown and .md get recognized):'), Pre('magic-transmute file --input input.md --output output.mjs'), h5({
      id: 'usage-cli-force-markdown'
    }, 'force markdown'), p('(arbitrary file extensions)'), Pre('magic-transmute file --input input.txt --output output.mjs --markdown'), h4({
      id: 'usage-api'
  ...
  '/transmute/404/': function transmute404() {
    return div('404 - not found');
  },
  '/transmute/html/': function transmuteHtml() {
  ...
  '/transmute/markdown/': function transmuteMarkdown() {
    ...
    }, 'markdown file example'), p('markdown file description'), p(['see ', Link({
    ...
    }, '@magic-themes'))]), p('the state looks like the following:'), pre([code(["---\n@state\n{\n  \"title\": \"markdown file example\",\n  \"description\": \"markdown file description\"\n}\n---"])])];
  }
};
app({
